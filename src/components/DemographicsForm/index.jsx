        ...
        <div className="max-w-md mx-auto px-4 py-12 flex flex-col justify-center min-h-screen">
            <div className="text-center mb-8">
                ...
                <p className="text-white/80 text-sm font-semibold tracking-widest uppercase mt-4">
                    {eventData?.name ? `Event: ${eventData.name}` : 'Sebelum memulai...'}
                </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        {ageRanges.map((range) => (
                            <button
                                ...
                                className={`py-3 px-4 rounded-lg font-bold transition-all border-2 ${ageRange === range
                    ...
                    <div className="space-y-2">
                        {genders.map((gen) => (
                            <button
                                ...
                                className={`w-full py-3 px-4 rounded-lg font-bold transition-all border-2 text-left ${gender === gen
                ...
                <button
                    ...
                    className={`w-full py-4 px-6 rounded-xl font-black uppercase tracking-wider flex items-center justify-center gap-2 transition-all text-lg mt-8 ${ageRange && gender
